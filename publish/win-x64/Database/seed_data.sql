...
INSERT INTO products (article, name, unit_id, price, supplier_id, manufacturer_id, category_id, discount, stock_quantity, description, image_path)
SELECT 'ZR70B4', 'Кирпич', units.id, 16.00, suppliers.id, manufacturers.id, categories.id, 3, 0, 'Кирпич рядовой силикатный Павловский завод полнотелый М200 250х120х65 мм 1NF', 'picture.png'
FROM units, suppliers, manufacturers, categories
...
INSERT INTO products (article, name, unit_id, price, supplier_id, manufacturer_id, category_id, discount, stock_quantity, description, image_path)
SELECT 'LPDDM4', 'Штукатурка гипсовая', units.id, 500.00, suppliers.id, manufacturers.id, categories.id, 6, 38, 'Штукатурка гипсовая Knauf Ротбанд 30 кг', 'picture.png'
FROM units, suppliers, manufacturers, categories
...
INSERT INTO products (article, name, unit_id, price, supplier_id, manufacturer_id, category_id, discount, stock_quantity, description, image_path)
SELECT 'LQ48MW', 'Штукатурка гипсовая', units.id, 462.00, suppliers.id, manufacturers.id, categories.id, 6, 33, 'Штукатурка гипсовая Knauf МП-75 машинная 30 кг', 'picture.png'
FROM units, suppliers, manufacturers, categories
...
INSERT INTO products (article, name, unit_id, price, supplier_id, manufacturer_id, category_id, discount, stock_quantity, description, image_path)
SELECT 'O43COU', 'Шпаклевка', units.id, 750.00, suppliers.id, manufacturers.id, categories.id, 1, 16, 'Шпаклевка полимерная Weber.vetonit LR + для сухих помещений белая 20 кг', 'picture.png'
FROM units, suppliers, manufacturers, categories
...
INSERT INTO products (article, name, unit_id, price, supplier_id, manufacturer_id, category_id, discount, stock_quantity, description, image_path)
SELECT 'M26EXW', 'Клей для плитки, керамогранита и камня', units.id, 340.00, suppliers.id, manufacturers.id, categories.id, 8, 0, 'Клей для плитки, керамогранита и камня Крепс Усиленный серый (класс С1) 25 кг', 'picture.png'
FROM units, suppliers, manufacturers, categories
WHERE units.name = 'шт.' AND suppliers.name = 'Knauf' AND manufacturers.name = 'Knauf' AND categories.name = 'Сухие строительные смеси и гидроизоляция';
INSERT INTO products (article, name, unit_id, price, supplier_id, manufacturer_id, category_id, discount, stock_quantity, description, image_path)
SELECT 'K0YACK', 'Смесь цементно-песчаная', units.id, 160.00, suppliers.id, manufacturers.id, categories.id, 8, 19, 'Смесь цементно-песчаная (ЦПС) 300 по ТУ MixMaster Универсал 25 кг', 'picture.png'
FROM units, suppliers, manufacturers, categories
...
INSERT INTO products (article, name, unit_id, price, supplier_id, manufacturer_id, category_id, discount, stock_quantity, description, image_path)
SELECT 'ASPXSG', 'Ровнитель', units.id, 711.00, suppliers.id, manufacturers.id, categories.id, 10, 20, 'Ровнитель (наливной пол) финишный Weber.vetonit 4100 самовыравнивающийся высокопрочный 20 кг', 'picture.png'
FROM units, suppliers, manufacturers, categories
WHERE units.name = 'шт.' AND suppliers.name = 'Weber' AND manufacturers.name = 'Weber' AND categories.name = 'Сухие строительные смеси и гидроизоляция';
INSERT INTO products (article, name, unit_id, price, supplier_id, manufacturer_id, category_id, discount, stock_quantity, description, image_path)
SELECT 'ZKQ5FF', 'Лезвие для ножа', units.id, 65.00, suppliers.id, manufacturers.id, categories.id, 6, 6, 'Лезвие для ножа Hesler 18 мм прямое (10 шт.)', 'picture.png'
FROM units, suppliers, manufacturers, categories
WHERE units.name = 'шт.' AND suppliers.name = 'Hesler' AND manufacturers.name = 'Hesler' AND categories.name = 'Ручной инструмент';
INSERT INTO products (article, name, unit_id, price, supplier_id, manufacturer_id, category_id, discount, stock_quantity, description, image_path)
SELECT '4WZEOT', 'Лезвие для ножа', units.id, 110.00, suppliers.id, manufacturers.id, categories.id, 6, 17, 'Лезвие для ножа Armero 18 мм прямое (10 шт.)', 'picture.png'
FROM units, suppliers, manufacturers, categories
WHERE units.name = 'шт.' AND suppliers.name = 'Armero' AND manufacturers.name = 'Armero' AND categories.name = 'Ручной инструмент';
INSERT INTO products (article, name, unit_id, price, supplier_id, manufacturer_id, category_id, discount, stock_quantity, description, image_path)
SELECT '4JR1HN', 'Шпатель', units.id, 26.00, suppliers.id, manufacturers.id, categories.id, 6, 7, 'Шпатель малярный 100 мм с пластиковой ручкой', 'picture.png'
FROM units, suppliers, manufacturers, categories
WHERE units.name = 'шт.' AND suppliers.name = 'Hesler' AND manufacturers.name = 'Hesler' AND categories.name = 'Ручной инструмент';
INSERT INTO products (article, name, unit_id, price, supplier_id, manufacturer_id, category_id, discount, stock_quantity, description, image_path)
SELECT 'Z3XFSP', 'Нож строительный', units.id, 63.00, suppliers.id, manufacturers.id, categories.id, 8, 5, 'Нож строительный Hesler 18 мм с ломающимся лезвием пластиковый корпус', 'picture.png'
FROM units, suppliers, manufacturers, categories
WHERE units.name = 'шт.' AND suppliers.name = 'Hesler' AND manufacturers.name = 'Hesler' AND categories.name = 'Ручной инструмент';
INSERT INTO products (article, name, unit_id, price, supplier_id, manufacturer_id, category_id, discount, stock_quantity, description, image_path)
SELECT 'I6MH89', 'Валик', units.id, 326.00, suppliers.id, manufacturers.id, categories.id, 12, 3, 'Валик Wenzo Roma полиакрил 250 мм ворс 18 мм для красок грунтов и антисептиков на водной основе с рукояткой', 'picture.png'
FROM units, suppliers, manufacturers, categories
...
INSERT INTO products (article, name, unit_id, price, supplier_id, manufacturer_id, category_id, discount, stock_quantity, description, image_path)
SELECT '83M5ME', 'Кисть', units.id, 122.00, suppliers.id, manufacturers.id, categories.id, 9, 26, 'Кисть плоская смешанная щетина 100х12 мм для красок и антисептиков на водной основе', 'picture.png'
FROM units, suppliers, manufacturers, categories
WHERE units.name = 'шт.' AND suppliers.name = 'Armero' AND manufacturers.name = 'Armero' AND categories.name = 'Ручной инструмент';
INSERT INTO products (article, name, unit_id, price, supplier_id, manufacturer_id, category_id, discount, stock_quantity, description, image_path)
SELECT '61PGH3', 'Очки защитные', units.id, 184.00, suppliers.id, manufacturers.id, categories.id, 6, 25, 'Очки защитные Delta Plus KILIMANDJARO (KILIMGRIN) открытые с прозрачными линзами', 'picture.png'
FROM units, suppliers, manufacturers, categories
...
INSERT INTO products (article, name, unit_id, price, supplier_id, manufacturer_id, category_id, discount, stock_quantity, description, image_path)
SELECT 'GN6ICZ', 'Каска защитная', units.id, 154.00, suppliers.id, manufacturers.id, categories.id, 15, 8, 'Каска защитная Исток (КАС001О) оранжевая', 'picture.png'
FROM units, suppliers, manufacturers, categories
WHERE units.name = 'шт.' AND suppliers.name = 'Исток' AND manufacturers.name = 'Исток' AND categories.name = 'Защита лица, глаз, головы';
INSERT INTO products (article, name, unit_id, price, supplier_id, manufacturer_id, category_id, discount, stock_quantity, description, image_path)
SELECT 'Z3LO0U', 'Очки защитные', units.id, 228.00, suppliers.id, manufacturers.id, categories.id, 9, 11, 'Очки защитные Delta Plus RUIZ (RUIZ1VI) закрытые с прозрачными линзами', 'picture.png'
FROM units, suppliers, manufacturers, categories
WHERE units.name = 'шт.' AND suppliers.name = 'RUIZ' AND manufacturers.name = 'RUIZ' AND categories.name = 'Защита лица, глаз, головы';
INSERT INTO products (article, name, unit_id, price, supplier_id, manufacturer_id, category_id, discount, stock_quantity, description, image_path)
SELECT 'QHNOKR', 'Маска защитная', units.id, 251.00, suppliers.id, manufacturers.id, categories.id, 2, 22, 'Маска защитная Исток (ЩИТ001) ударопрочная и термостойкая', 'picture.png'
FROM units, suppliers, manufacturers, categories
WHERE units.name = 'шт.' AND suppliers.name = 'Исток' AND manufacturers.name = 'Исток' AND categories.name = 'Защита лица, глаз, головы';
INSERT INTO products (article, name, unit_id, price, supplier_id, manufacturer_id, category_id, discount, stock_quantity, description, image_path)
SELECT 'EQ6RKO', 'Подшлемник', units.id, 36.00, suppliers.id, manufacturers.id, categories.id, 17, 22, 'Подшлемник для каски одноразовый', 'picture.png'
FROM units, suppliers, manufacturers, categories
...
INSERT INTO products (article, name, unit_id, price, supplier_id, manufacturer_id, category_id, discount, stock_quantity, description, image_path)
SELECT '81F1WG', 'Каска защитная', units.id, 1500.00, suppliers.id, manufacturers.id, categories.id, 2, 13, 'Каска защитная Delta Plus BASEBALL DIAMOND V UP (DIAM5UPBCFLBS) белая', 'picture.png'
FROM units, suppliers, manufacturers, categories
WHERE units.name = 'шт.' AND suppliers.name = 'Delta' AND manufacturers.name = 'Delta' AND categories.name = 'Защита лица, глаз, головы';
INSERT INTO products (article, name, unit_id, price, supplier_id, manufacturer_id, category_id, discount, stock_quantity, description, image_path)
SELECT '0YGHZ7', 'Очки защитные', units.id, 700.00, suppliers.id, manufacturers.id, categories.id, 9, 36, 'Очки защитные Husqvarna Clear (5449638-01) открытые с прозрачными линзами', 'picture.png'
FROM units, suppliers, manufacturers, categories
WHERE units.name = 'шт.' AND suppliers.name = 'Husqvarna' AND manufacturers.name = 'Husqvarna' AND categories.name = 'Защита лица, глаз, головы';
INSERT INTO products (article, name, unit_id, price, supplier_id, manufacturer_id, category_id, discount, stock_quantity, description, image_path)
SELECT 'O43COU8', 'Товар O43COU8', units.id, 0.00, suppliers.id, manufacturers.id, categories.id, 0, 0, 'Товар добавлен при подготовке импортных данных, так как он встречается в заказах, но отсутствует в исходном файле товаров.', 'picture.png'
FROM units, suppliers, manufacturers, categories
